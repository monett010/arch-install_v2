...
function installDesktopEnv(){
	...
	'budgie')
		...
		;;
	'cinnamon')
		install_="cinnamon mate-terminal budgie-backgrounds pluma libvoikko nuspell hunspell hspell aspell kupfer plank blueman touchegg onboard gnome-screenshot xdg-user-dirs"
		;;
	'kde')
